...
export const TodoApp = {
  ...
  SUBTITLE: 'TODO_APP.SUBTITLE',
  PLACEHOLDER: 'TODO_APP.PLACEHOLDER',
  ADD: 'TODO_APP.ADD',
  ALL: 'TODO_APP.ALL',
  ACTIVE: 'TODO_APP.ACTIVE',
  COMPLETED: 'TODO_APP.COMPLETED',
  ITEMS_LEFT: 'TODO_APP.ITEMS_LEFT',
  CLEAR_COMPLETED: 'TODO_APP.CLEAR_COMPLETED',
  EMPTY_STATE: 'TODO_APP.EMPTY_STATE',
  EMPTY_STATE_ACTIVE: 'TODO_APP.EMPTY_STATE_ACTIVE',
  EMPTY_STATE_COMPLETED: 'TODO_APP.EMPTY_STATE_COMPLETED',
} as const;